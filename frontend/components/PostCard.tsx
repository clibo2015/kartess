      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-4">
            ...
            {modules.map((module) => (
              <span
                ...
                className={`px-2 py-1 text-xs font-medium rounded ${
                  moduleColors[module] || 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300'
                }`}
              >
                {module}
              </span>
        ...
        {mediaUrls.length > 0 && (
          <div className="mb-3">
            {mediaUrls.length === 1 ? (
              <div
                className="relative w-full aspect-video rounded-lg overflow-hidden cursor-pointer bg-gray-100 dark:bg-gray-700"
              ...
              <div className="grid grid-cols-2 gap-2">
                {mediaUrls.slice(0, 4).map((url, idx) => (
                  <div
                    key={idx}
                    className="relative aspect-square rounded-lg overflow-hidden cursor-pointer bg-gray-100 dark:bg-gray-700"
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
          <ReactionsBar post={post} variant="default" />
